...
## [0.8.2](https://github.com/killerapp/bevy-sensor/compare/v0.8.1...v0.8.2) - 2026-06-23

### Fixed

- *(render)* reject target-in-frame blank captures

## [0.8.1](https://github.com/killerapp/bevy-sensor/compare/v0.8.0...v0.8.1) - 2026-06-21

### Fixed

- accept stable all-background render frames

### Other

- Accept close surface-policy depth frames
- Add depth fallback diagnostics
...
- *(render)* reset persistent capture settle state

## [0.7.0](https://github.com/killerapp/bevy-sensor/compare/v0.6.0...v0.7.0) - 2026-06-16

### Added

- expose semantic 3d render rows ([#99](https://github.com/killerapp/bevy-sensor/pull/99))
...
- TBP/YCB object targeting APIs, mesh-center target metadata, render-health diagnostics, and center-hit validation for NeoCortx parity workflows ([#82](https://github.com/killerapp/bevy-sensor/pull/82))
...
## [0.5.4](https://github.com/killerapp/bevy-sensor/compare/v0.5.3...v0.5.4) - 2026-06-01

### Fixed

- *(render)* align output intrinsics with TBP zoom formula ([#73](https://github.com/killerapp/bevy-sensor/pull/73))

## [0.5.3](https://github.com/killerapp/bevy-sensor/compare/v0.5.2...v0.5.3) - 2026-04-25

### Fixed

- *(release)* keep 0.x features as minor bumps ([#68](https://github.com/killerapp/bevy-sensor/pull/68))
